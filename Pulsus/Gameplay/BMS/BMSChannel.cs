...
namespace Pulsus.Gameplay
{
	...
	public class BMSChannel
	{
		...
		private static HashSet<int> supportedTypes;
		static BMSChannel()
		{
			supportedTypes = new HashSet<int>();
			foreach (int typeValue in Enum.GetValues(typeof(Type)))
				supportedTypes.Add(typeValue);
			foreach (int typeValue in Enum.GetValues(typeof(KeyBMS)))
				supportedTypes.Add(typeValue);
			foreach (int typeValue in Enum.GetValues(typeof(KeyPMS)))
				supportedTypes.Add(typeValue);
		}
